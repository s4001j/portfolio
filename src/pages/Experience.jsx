...
export default function Experience(){
    ...
    const career = [
        ...
        {
            id:2,
            job:"자동차 내비&인포테인먼트시스템 및 서빙로봇 SW QA/QE (총 경력 2년 3개월)",
            text:"타 업체/부서와의 협업 (고객사 품질보증팀 매니저의 요청에 따른 테스팅 수행 후 결과 보고), JIRA를 통한 개발자와의 협업, 개발자 수정 후 확인 테스팅 및 리그레션 테스팅 수행을 통해 이슈를 걸러냄으로써 품질 향상과 기획 및 고객의 니즈에 부합한 제품으로 만들어지도록 기여함.",
        },
        {
            id:3,
            job:"자동차 내비&인포테인먼트시스템&계기판 HW DQA (총 경력 2년 1개월)",
            text:"타 업체/부서와의 협업 (고객사 품질보증팀 매니저의 요청에 따른 테스팅 수행 후 결과 보고), 개발자 수정 후 확인 및 리그레션 테스팅 수행을 통해 이슈를 걸러냄으로써 품질의 신뢰성을 확보하고 안정적인 제품이 만들어지도록 기여함.",
        },
    ]
